  ...
  return (
    <div className={`relative rounded-sm overflow-hidden p-[0.125rem] max-w-[77%] h-8 ${className}`}>
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(#8CF056 50%, #4A9A5A 80%, transparent 100%)',
          boxShadow: '0 0 0.5rem rgba(140, 240, 86, 0.6)',
        }}
      />
      ...
      <button
        onClick={onClick}
        className="group relative w-full h-full bg-[#19292F] hover:bg-[#1f3740] active:scale-[0.98] transition duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/10 border-[1px] border-border-light flex items-center justify-center gap-2 px-3 rounded-sm z-10"
      >
